  ...
  render() {
    ...
    return (
      ...
      <div className="locations-details">
        ...
        <a href='https://maps.google.com/?daddr=12300%20Jefferson%20Avenue%20Newport%20News%2C%20VA%2023608' className='inline-link'  rel='noopener noreferrer' target="_blank"> Get directions here! </a>
      </div>
        <div id="map"></div>
      </div>
